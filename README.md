...
```
2. 编辑 `config\config.yaml` 文件，设置您的模型提供商URL，API密钥及其他参数
...
1. 复制配置示例文件：
```bash
copy prompts\example.json prompts\prompt1.json
```
2. 编辑 `prompts\prompt1.json` 文件，设置提示词
